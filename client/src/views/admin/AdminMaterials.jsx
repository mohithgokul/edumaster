              ...
              <div>
                ...
                {!!mat.summary?.trim() && (
                  <div className="mb-3">
                    ...
                    >
                      {expandedSummaryIds.has(mat._id) ? 'Hide Summary' : 'View Summary'}
                    </button>

                    {expandedSummaryIds.has(mat._id) && (
                      <div
                        className="mt-2 p-3 rounded-lg border border-th-border/10 text-sm text-th-muted"
                        style={{
