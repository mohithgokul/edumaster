...
app.use('/api/materials', require('./controllers/materials'));
app.use('/api/flashcards', require('./controllers/flashcards'));
app.use('/api/studyplans', require('./controllers/studyplans'));
app.use('/api/progress', require('./controllers/progress'));
app.use('/api/leaderboard', require('./controllers/leaderboard'));
